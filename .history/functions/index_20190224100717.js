...
app.intent("Default Welcome Intent", conv => {
    const speech = `<speak>Bienvenue sur Job de Développeur,<break time='300ms'/> la 1ère Application de mise en relation entre développeur et recruteurs.<break time='500ms'/> \n 
Tu cherches de nouvelles missions ?<break time='200ms'/> Une nouvelle opportunité de Développeur ?<break time='600ms'/> \n
Avec notre application, tu seras directement mise en relation pour un entretien technique,<break time='300ms'/> en moins de 48h. autour de chez toi. <break time='500ms'/>\n
Peux-tu nous dire quelles sont les technologies ou langages que tu recherches ?</speak>`
...
app.intent("Skills", async (conv, { skills }) => {
    ...
    let speech = `<speak> Superbe ! <break time='500ms'/> 
    ...
    conv.ask(new BasicCard({
        title: '',
        image: new Image({
            url: 'https://firebasestorage.googleapis.com/v0/b/console-28d14.appspot.com/o/developpeurs-france-lieu.jpg?alt=media&token=4bcd6246-b6e6-441b-898a-76afd5a60a77',
            alt: 'Ville souhaitée',
        }),
    }));
...
app.intent("City", async (conv, { city }) => {
    ...
    const speech = `<speak>Impeccable ! Nous recherchons sur ${city} les meilleurs offres actuellement disponibles. <break time='500ms'/> 
    ...
    conv.ask(new BasicCard({
        title: '',
        image: new Image({
            url: 'https://firebasestorage.googleapis.com/v0/b/console-28d14.appspot.com/o/experience-dev-4.jpg?alt=media&token=ee5366f7-cc54-4fda-9a51-c1f3ed6978f7',
            alt: 'Ville souhaitée',
        }),
    }));

    conv.ask(new Suggestions(["1 an", "3 années", "Moins de 5 ans", "Plus de 5 ans", "Plus de 10 ans"]));
});
...
app.intent("Level", async (conv, { level }) => {
    ...
    const speech = `<speak>Génial ! <break time='500ms'/> 
    ...
    conv.ask(new BasicCard({
        title: '',
        image: new Image({
            url: 'https://firebasestorage.googleapis.com/v0/b/console-28d14.appspot.com/o/comment-preparer-et-reussir-son-entretien-telephonique-e1528277876285.jpg?alt=media&token=df8809f9-02c8-40f9-bbac-9e2119b209fc',
            alt: "Numéro d'appel",
        }),
    }));
...
Tu seras rapidement mise en relation avec une entreprise pour convenir un entretien technique. <break time='1000ms'/>
Si tu as aimé cette application, n'hésites pas à mettre une petite note sur Google Assistant.<break time='500ms'/> 
Bon courage pour ton rendez-vous technique et à bientôt! </speak>`
    }
