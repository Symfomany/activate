...
app.intent("Level", async (conv, { level }) => {
    ...
    conv.ask(new BasicCard({
        title: 'Experiences acquises',
        image: new Image({
            url: 'https://firebasestorage.googleapis.com/v0/b/console-28d14.appspot.com/o/langages-programmation-2017.jpg?alt=media&token=ca083821-0d23-4f48-b705-ef19c73c85cc',
            alt: 'Numéro souhaitée',
        }),
        display: 'CROPPED',
    }));
